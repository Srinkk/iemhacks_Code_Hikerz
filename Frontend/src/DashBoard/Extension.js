...
const Extension = () => {
  ...
  const handleCheckboxChange = (event) => {
    ...
    if (!privacyAgreed) {
      axios
        .post("http://localhost:3500/user/getAuthKey", { _id: _id })
        .then((response) => {
          ...
          <div className="col-lg-10">
            ...
            >
              ...
              <div className="policy_content">
                <p>
                  Welcome to Emotions ("we," "us," or "our"). We are committed
                  to respecting your privacy and protecting your personal
                ...
                <p>
                  <ul>
                    ...
                    <li>
                      ...
                      <a href="chrome://extensions/">Click here </a> and turn on
                      the developer mode.
                    </li>
                    <li>
                ...
                <FormGroup>
                  <FormControl>
                    <label>
                      ...
                      <FormLabel>
                        <h5>
                          I have read and agree to emotion's{" "}
